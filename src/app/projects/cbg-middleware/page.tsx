...
export const metadata: Metadata = {
  title: "CBG Middleware Project | Kulana IT Solutions",
  description: "CBG Middleware Project — Kulana IT Solutions",
};

export default function CbgMiddlewarePage() {
  return (
    <>
      <Navbar />
        ...
        <section className="gradient-hero relative overflow-hidden py-28 text-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-5xl lg:text-6xl font-extrabold mb-6 leading-tight">
              CBG Middleware Project
            </h1>
          </div>
        </section>

        <section className="flex flex-col items-center justify-center py-32 px-4 text-center">
          <div className="w-24 h-24 rounded-3xl bg-violet-50 border border-violet-100 flex items-center justify-center mb-8">
            <Hammer className="w-12 h-12 text-violet-500" strokeWidth={1.5} />
          </div>
          ...
          <p className="text-gray-500 text-lg max-w-md leading-relaxed mb-10">
            The CBG Middleware Project page is currently being built. Check back soon for full project details,
