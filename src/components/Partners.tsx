      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {partners.map((p) => (
            <div
              key={p.name}
              className="group bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center hover:border-[#03B2EE]/40 hover:bg-white/10 hover:shadow-md transition-all cursor-default"
            >
              ...
              <div className="text-xs font-semibold text-white/80 leading-tight mb-1">
                {p.name}
              </div>
